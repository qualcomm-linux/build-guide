  ...
  .. list-table:: Mapping Yocto layers to manifest release tags
     ...
     * - 
       ...
       - BSP build: High-level OS and prebuilt firmware (GPS only)
         ...
         ``qcom-6.6.136-QLI.1.9-Ver.1.1.xml``
       - ``qcom-wayland``
     * - 
         - ``meta-qcom``
         - ``meta-qcom-hwe``
       ...
       - BSP build + Qualcomm IM SDK build:
         ...
         ``qcom-6.6.136-QLI.1.9-Ver.1.1_qim-product-sdk-2.4.1.xml``
       - ``qcom-wayland``
     * - 
         - ``meta-qcom``
         - ``meta-qcom-hwe``
       ...
       - BSP build + Real-time kernel build:
         ``qcom-6.6.136-QLI.1.9-Ver.1.1_realtime-linux-1.1.xml``
...
1. Download Qualcomm Yocto and the supporting layers. For the latest ``<manifest release tag>``, see the section *Build-critical release tags* in the `Release Notes <https://docs.qualcomm.com/doc/80-70030-300/>`__.
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         # Example, <manifest release tag> is qcom-6.6.136-QLI.1.9-Ver.1.1.xml
         repo sync
...
#. Clone the Qualcomm IM SDK layer into the workspace:
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         # Example, <meta-qcom-qim-product-sdk release tag> is qcom-6.6.136-QLI.1.9-Ver.1.1_qim-product-sdk-2.4.1
...
#. Download the QIR SDK layers into the BSP build ``<WORKSPACE DIR>``
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         git clone https://github.com/quic-yocto/meta-qcom-robotics.git -b qcom-6.6.136-QLI.1.9-Ver.1.1_robotics-sdk-1.1 layers/meta-qcom-robotics
         git clone https://github.com/quic-yocto/meta-qcom-robotics-distro.git -b qcom-6.6.136-QLI.1.9-Ver.1.1_robotics-sdk-1.1 layers/meta-qcom-robotics-distro
         git clone https://github.com/quic-yocto/meta-qcom-robotics-sdk.git -b qcom-6.6.136-QLI.1.9-Ver.1.1_robotics-sdk-1.1 layers/meta-qcom-robotics-sdk
         git clone https://github.com/quic-yocto/meta-qcom-qim-product-sdk -b qcom-6.6.136-QLI.1.9-Ver.1.1_qim-product-sdk-2.4.1 layers/meta-qcom-qim-product-sdk
...
#. Clone the real-time Linux layer into the workspace:
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         # Example, <meta-qcom-realtime release tag> is qcom-6.6.136-QLI.1.9-Ver.1.1_realtime-linux-1.1
