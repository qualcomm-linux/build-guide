...
-----------------------------
To build your own configuration, you must compile the build for default machine configuration and compile the LE.QCLINUX.2.0 image with your own machine and distribution parameter values.
...
2. Compile the ``LE.QCLINUX.2.0`` image with your own machine and distribution parameter values.
