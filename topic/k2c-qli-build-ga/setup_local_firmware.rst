...
#. Unzip the bootbinaries zip file if you do not have the unzipped version.
...
#. Copy the DSPSO binaries from the firmware zip file to the devtool workspace:
  ...
  .. container:: nohighlight
    ...
    ::
         ...
         # Copy the DSPSO binaries for your chipset for aDSP, cDSP and gDSP
...
After you run these steps, the next :ref:`Yocto image build <step4_build_software_image>` picks up the local firmware binaries.