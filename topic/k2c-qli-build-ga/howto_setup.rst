...
Connect to ADB
^^^^^^^^^^^^^^^^
See `Install and connect to ADB <https://docs.qualcomm.com/bundle/publicresource/topics/80-80020-251/faqs.html#install-adb>`__.
...
.. note:: 
   ...
   - To create a non-root user account, see `Create a non-root user account <https://docs.qualcomm.com/bundle/publicresource/topics/80-80020-251/faqs.html#non-root-acc>`__.
...
- Upgrade the software as described in `Update the software <https://docs.qualcomm.com/bundle/publicresource/topics/80-80020-251/upgrade-rb3gen2-software.html>`__ before updating the Renesas firmware.
