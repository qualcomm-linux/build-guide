   ...
   **Example**
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         repo init -u https://github.com/quic-yocto/qcom-manifest -b qcom-linuxSTXscarthgap -m qcom-6.6.136-QLI.1.9-Ver.1.1.xml
         # with
         repo init -u https://github.com/quic-yocto/qcom-manifest -b qcom-linux-scarthgap -m qcom-6.6.136-QLI.1.9-Ver.1.1.xml
   ...
   **Error excerpt**
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         git clone -b r1.0_00129.0 --depth 1 https://qpm-git.qualcomm.com/home2/git/qualcomm/qualcomm-linux-spf-1-0_ap_standard_oem_nm-qimpsdk.g…
